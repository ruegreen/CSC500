...
class ShoppingCart(object):
    ...
    def modify_item(self, ItemToPurchase):
        ...
        for item in self.cart_items:
            ...
            if ItemToPurchase.item_name == item.item_name:
                ...
                if ((item.item_description != "none") and (item.item_price != 0) and (item.item_quantity != 0)):
                    ...
                    #Uncomment out the next two lines if you want to allow description and price to be modified, make sure to update main menu to collect new values
                    #for description and item_price
    ...
    def print_description(self):
        ...
        if(self.get_num_items_in_cart() == 0):
            ...
            print("PRINT OUT CART ITEM DESCRIPTION ONLY")
            print(f"{self.customer_name}'s Shopping Cart - {self.current_date}")
            print(f"Number of Items: {len(self.cart_items)}")
...
def main():
    ...
    menu_options = {
        ...
        4: 'i - Output item\'s descriptions',
    ...
    def print_menu(shopping_cart):
        ...
        if option == "a":
            ...
            #dont remove anything if the cart is empty
            ...
            #dont change anything if the cart is empty...
            if(shopping_cart.get_num_items_in_cart() == 0):
                print("Shopping Cart is EMPTY!")
            else:
                print("CHANGE ITEM QUANTITY IN CART")
                item_name = input("Enter the name for item you would like to update: ")
                #Uncomment the next two lines if you want to allow user to also update item description and price, remember to modify the modify_item class method as well
                ...
                #If you would like to allow the user to modify description and price of item, uncomment the next line, comment the line after the next line and
                #modify the lines above and in the modify_item class method accordingly
                shopping_cart.modify_item(ItemToPurchase(item_name,"none",0,int(item_quantity)))
    ...
    current_date = input("What date would you like me to use? (Press Enter to use today's date!) ")
    if current_date is "":
